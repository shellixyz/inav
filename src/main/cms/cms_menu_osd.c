...
static const OSD_Entry menuOsdHudEntries[] = {
    ...
    OSD_SETTING_ENTRY("HUD DISPLAY MODE", SETTING_OSD_HUD_MODE),
    OSD_SETTING_ENTRY("HUD SHOW HOME", SETTING_OSD_HUD_DISP_HOME),
    OSD_SETTING_ENTRY("HUD MAX POIS", SETTING_OSD_HUD_DISP_POIS),
    OSD_SETTING_ENTRY("DEBUG NEAREST POI", SETTING_OSD_HUD_DEBUG),
