...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    /*{ TIM1, IO_TAG(PB14),  TIM_Channel_2, 0 | TIMER_OUTPUT_N_CHANNEL, IOCFG_AF_PP, GPIO_AF_6,  TIM_USE_PWM },*/
    /*{ TIM1, IO_TAG(PB15),  TIM_Channel_3, 0 | TIMER_OUTPUT_N_CHANNEL, IOCFG_AF_PP, GPIO_AF_4,  TIM_USE_PWM },*/
    { TIM15, IO_TAG(PB14),  TIM_Channel_1, 0, IOCFG_AF_PP, GPIO_AF_1,  TIM_USE_PWM }, // SOFTSERIAL RX (MISO)
    { TIM15, IO_TAG(PB15),  TIM_Channel_2, 0, IOCFG_AF_PP, GPIO_AF_1,  TIM_USE_PWM }, // SOFTSERIAL TX (MOSI)
    ...
    { TIM2, IO_TAG(PA3),  TIM_Channel_4, 1, IOCFG_AF_PP, GPIO_AF_1,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }, // Pin PWM3 - PA3
    { TIM2, IO_TAG(PA2),  TIM_Channel_3, 1, IOCFG_AF_PP, GPIO_AF_1,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO }, // Pin PWM4 - PA2
