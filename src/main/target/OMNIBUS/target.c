...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM8,  IO_TAG(PB9),  TIM_Channel_3, 1, IOCFG_AF_PP, GPIO_AF_10,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR }, // Pin PWM2 - PB9
    ...
    { TIM4, IO_TAG(PB6), TIM_Channel_1, 1, IOCFG_AF_PP, GPIO_AF_2,  TIM_USE_PWM }, // SOFTSERIAL RX
    { TIM4, IO_TAG(PB6), TIM_Channel_2, 1, IOCFG_AF_PP, GPIO_AF_2,  TIM_USE_PWM }, // SOFTSERIAL TX
