...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    /*{ TIM1, IO_TAG(PB14),  TIM_Channel_2, 0 | TIMER_OUTPUT_N_CHANNEL, IOCFG_AF_PP, GPIO_AF_6,  TIM_USE_ANY },*/
    /*{ TIM1, IO_TAG(PB15),  TIM_Channel_3, 0 | TIMER_OUTPUT_N_CHANNEL, IOCFG_AF_PP, GPIO_AF_4,  TIM_USE_ANY }*/
