...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM2,  IO_TAG(PA3),  TIM_CHANNEL_4, 1, IOCFG_AF_PP_PD, GPIO_AF1_TIM2,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR | TIM_USE_FW_SERVO }, // S1_OUT 7
    { TIM5,  IO_TAG(PA1),  TIM_CHANNEL_2, 1, IOCFG_AF_PP_PD, GPIO_AF2_TIM5,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR | TIM_USE_FW_SERVO }, // S2_OUT 8
