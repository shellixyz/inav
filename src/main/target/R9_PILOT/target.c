...
BUSDEV_REGISTER_SPI_TAG(busdev_imu0,    DEVHW_MPU6500,      MPU6500_SPI_BUS,    MPU6500_CS_PIN,     GYRO_INT_EXTI,       0,  DEVFLAGS_NONE);

const timerHardware_t timerHardware[] = {
    /*DEF_TIM(TIM8,  CH2N, PB0, TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),*/
    /*DEF_TIM(TIM8,  CH3N, PB1, TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),*/
    DEF_TIM(TIM3,  CH3, PB0,  TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, 0, 0),
    ...
    DEF_TIM(TIM4,  CH3, PB8,  TIM_USE_MC_MOTOR                   , 0, 0),

    DEF_TIM(TIM11, CH1, PB9,                     TIM_USE_FW_MOTOR, 0, 0),
    DEF_TIM(TIM4,  CH4, PB9,  TIM_USE_MC_MOTOR                   , 0, 0),
